...
namespace Metaballs3D
{
    public class Camera
    {
        ...
        public static void MouseEvents(KeyboardKeyEventArgs e)
        {
        ...
        static float local_z_dir;
        static float local_x_dir;

        static float rotate_leftright_key;
        static float rotate_updown_key;
